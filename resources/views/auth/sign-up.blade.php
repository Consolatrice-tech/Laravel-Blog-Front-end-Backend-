...
<head>
  ...
  <link rel="shortcut icon" type="{{asset('frontend/image/png')}}" href="{[asset('frontend/img/favicon.png')}}" >
      ...
      <form method="POST" action=" {{ route('register') }}">
        ...
        <div class="uk-width-1-1 uk-text-center">
          <button class="uk-button uk-button-primary uk-button-large">
            <a class="uk-text-small uk-link-muted" href="/dashboard">Sign Up</a></button>
        </div>
